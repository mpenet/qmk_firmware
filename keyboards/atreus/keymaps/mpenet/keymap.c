...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_BSPC, KC_ESC,  KC_TAB, KC_LGUI,  KC_LSFT, KC_LCTL, KC_LALT, KC_SPC,  MO(_RS), KC_MINS, KC_QUOT, KC_ENT
  ),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    TG(_LW), KC_INS,  KC_LGUI, KC_LSFT, KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,  KC_TRNS, KC_0, KC_DOT, KC_EQL
  ),
